-- From the following table, write a SQL query to locate the details 
...
-- who do not belong to the city of 'New York' or have a grade value that exceeds 100. 
--Return customer_id, cust_name, city, grade, and salesman_id.
SELECT customer_id, cust_name, city, grade, salesman_id
FROM customer
...
-- of those salespeople whose commissions range from 0.10 to0.12. 
-- Return salesman_id, name, city, and commission.
SELECT salesman_id, name, city, commission
FROM salesman
WHERE commission > 0.10 AND commission < 0.12

-- From the following table, write a SQL query to find details 
-- of all orders with a purchase amount less than 200 or exclude 
-- orders with an order date greater than or equal to '2012-02-10' 
...
-- orders that meet the following conditions. 
-- Exclude combinations of order date equal to '2012-08-17' or customer 
...
-- and the achieved and unachieved percentage (%) for those orders 
...
-- the employees who work at depart 47 or 63. 
-- Return emp_idno, emp_fname, emp_lname, and emp_dept.
SELECT emp_idno, emp_fname, emp_lname, emp_dept
FROM emp_details
